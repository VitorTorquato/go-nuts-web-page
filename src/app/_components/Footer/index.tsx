  ...
  return (
    <section className="w-full bg-[#f9509973] pt-2  mt-9">
      ...
      <footer className="w-full">
        <div className="container mx-auto border-t-2 border-slate-600  flex items-center justify-between py-2 px-2">
          ...
          <div className="flex gap-2 items-center">
            <Link href={`https://www.instagram.com/gonutsbr/`} target="_blank">
              <BsInstagram size={24} color="#000" />
            </Link>

            <Link href={`https://www.facebook.com/GoNutsCakesBr/`} target="_blank">
